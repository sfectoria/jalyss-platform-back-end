...
const categorie_client_controller_1 = require("./categorie_client.controller");
...
exports.CategorieClientModule = CategorieClientModule = __decorate([
    (0, common_1.Module)({
        controllers: [categorie_client_controller_1.CategorieClientsController],
        providers: [categorie_client_service_1.CategorieClientsService],
    })
], CategorieClientModule);
//# sourceMappingURL=categorie_client.module.js.map