...
__decorate([
    (0, microservices_1.MessagePattern)({ cmd: 'create_publishingHouse' }),
...
__decorate([
    (0, microservices_1.MessagePattern)({ cmd: 'all_publishingHouses' }),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
], PublishingHousesController.prototype, "findAll", null);
__decorate([
    (0, microservices_1.MessagePattern)({ cmd: 'getOne_publishingHouse' }),
    __param(0, (0, microservices_1.Payload)()),
    __metadata("design:type", Function),
...
__decorate([
    (0, microservices_1.MessagePattern)({ cmd: 'update_publishingHouse' }),
    __param(0, (0, microservices_1.Payload)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
...
__decorate([
    (0, microservices_1.MessagePattern)({ cmd: 'delete_publishingHouse' }),
    __param(0, (0, microservices_1.Payload)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
